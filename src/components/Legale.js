    ...
    <div class="single mt-125">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                <p>
                  Ce site est la propriété de la société COMM, SAS à capital variable, RCS Bordeaux B 479 144 438, dont les coordonnées sont :
                </p>
                <ul class="ul-group">
                    <li><strong> Adresse du siège social : </strong> Parc Aquilae - 2ieme étage - Immeuble Celadon - Rue de la Blancherie - 33370 Artigues-Près-Bordeaux.</li>
                  ...
                  <section id="politiques">
                      <h3>POLITIQUE DE CONFIDENTIALITÉ DES DONNÉES PERSONNELLES</h3>
                      ...
                      <ul class="ol-group">
                          <li><strong> Données d’identification :  </strong>  nom, prénom, date de naissance, adresse postale et courriel, numéro de téléphone, SIREN, etc</li>
                          <li><strong> Données de facturation et/ou paiement : </strong>coordonnées bancaires, moyen de paiement, etc</li>
                          <li><strong> Données de suivi de la relation client : </strong> services souscrits, communications avec le Partenaire, etc</li>
                          <li><strong> Données de navigation : </strong> cookies, etc</li>
                      </ul>
                  ...
                  <section id="liens">
                    ...
                    <p>Ce site propose des liens hypertextes pointant vers des sites Internet édités par des tiers. Ces liens sont établis de bonne foi et la société COMM ne peut être tenue pour responsable de modifications intervenues sur ces sites. Par conséquent, ces liens hypertextes ne sauraient, en aucun cas, engager la responsabilité de la société COMM : seule la responsabilité des éditeurs des sites référencés sur le site de la société COMM pourra être engagée.</p>
                  </section>
                  <section id="droits">
